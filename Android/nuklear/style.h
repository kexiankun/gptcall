...
static void set_style(struct nk_context *ctx, enum theme theme) {
  ...
  if (theme == THEME_BLACK) {
    ...
    table[NK_COLOR_BORDER] = nk_rgba(140, 159, 173, 200);
    table[NK_COLOR_BUTTON] = nk_rgba(137, 182, 224, 200);
    table[NK_COLOR_BUTTON_HOVER] = nk_rgba(142, 187, 229, 255);
    table[NK_COLOR_BUTTON_ACTIVE] = nk_rgba(147, 192, 234, 255);
    table[NK_COLOR_TOGGLE] = nk_rgba(177, 210, 210, 200);
    table[NK_COLOR_TOGGLE_HOVER] = nk_rgba(182, 215, 215, 255);
    table[NK_COLOR_TOGGLE_CURSOR] = nk_rgba(137, 182, 224, 255);
    table[NK_COLOR_SELECT] = nk_rgba(177, 210, 210, 200);
    table[NK_COLOR_SELECT_ACTIVE] = nk_rgba(137, 182, 224, 200);
    table[NK_COLOR_SLIDER] = nk_rgba(177, 210, 210, 200);
    table[NK_COLOR_SLIDER_CURSOR] = nk_rgba(137, 182, 224, 245);
    table[NK_COLOR_SLIDER_CURSOR_HOVER] = nk_rgba(142, 188, 229, 255);
    table[NK_COLOR_SLIDER_CURSOR_ACTIVE] = nk_rgba(147, 193, 234, 255);
    table[NK_COLOR_PROPERTY] = nk_rgba(210, 210, 210, 200);
    table[NK_COLOR_EDIT] = nk_rgba(210, 210, 210, 225);
    table[NK_COLOR_EDIT_CURSOR] = nk_rgba(20, 20, 20, 200);
    table[NK_COLOR_COMBO] = nk_rgba(210, 210, 210, 200);
    table[NK_COLOR_CHART] = nk_rgba(210, 210, 210, 200);
    table[NK_COLOR_CHART_COLOR] = nk_rgba(137, 182, 224, 200);
    table[NK_COLOR_CHART_COLOR_HIGHLIGHT] = nk_rgba(200, 0, 0, 200);
    table[NK_COLOR_SCROLLBAR] = nk_rgba(190, 200, 200, 200);
    table[NK_COLOR_SCROLLBAR_CURSOR] = nk_rgba(64, 84, 95, 200);
    table[NK_COLOR_SCROLLBAR_CURSOR_HOVER] = nk_rgba(70, 90, 100, 200);
    table[NK_COLOR_SCROLLBAR_CURSOR_ACTIVE] = nk_rgba(75, 95, 105, 200);
    table[NK_COLOR_TAB_HEADER] = nk_rgba(156, 193, 220, 200);
    nk_style_from_table(ctx, table);
